...
311 data was only available for Minneapolis. Crime data exists for St. Paul but was not geocoded, and only had block addresses; geocoding would take too long.
